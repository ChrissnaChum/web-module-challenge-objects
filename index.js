...
console.log('task 1 b', createMenuItem('noodles', 10, 'Lunch'));
console.log('task 1 b', createMenuItem('soup', 5, 'Sides'));
console.log('task 1 b', createMenuItem('rice', 5, 'Sides'));
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
console.log('task 5', reviews.push('Daniela', 5, 'Beautiful atmosphere and wonderful vegan options!'));
